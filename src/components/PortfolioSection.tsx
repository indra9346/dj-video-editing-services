...
const portfolioData = {
  Food: {
    ...
    videos: ["FN0VWR3SlWY", "Nf9jAmS5B6A", "q-FLyFRsmgE"]
  },
  Ambience: {
    ...
    videos: ["UNgdV9PwZ_w", "fI63c3qoZeI", "4egEYDsl31c", "CQH7xp2r-vI"]
  },
  Gym: {
    ...
    videos: ["X2KIJ_EsmpE", "GA3qjVYAtFM", "ylO6i9-Ixzo", "tc0y5id6o0w", "VTvj1OJyv9Q"]
  },
  Events: {
...
"o2wqCkF3K7M"]
  ...
  Podcast: {
    ...
    videos: ["345f8wrJ-sQ", "Bctc0gKD4mM", "y_6PfnMMrhI"]
  }
};
...
const PortfolioSection = () => {
  ...
  const currentCategoryData = selectedCategory
    ? portfolioData[selectedCategory as keyof typeof portfolioData]
    : null;

  const handleSelectCategory = (name: string) => {
    setSelectedCategory(name);
    // Scroll to top of the portfolio section so videos are visible
    setTimeout(() => {
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            Explore my best video editing projects across different categories — from cinematic weddings to high-energy events.
          </p>
        </div>
          ...
          {!selectedCategory ? (
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {currentCategoryData?.videos.map((id, i) => (
                  <motion.div
                    key={id}
